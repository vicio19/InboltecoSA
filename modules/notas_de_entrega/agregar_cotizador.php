...
if (!empty($id) and !empty($cantidad) and !empty($precio_venta))
{
	...
	$insert_tmp=mysqli_query($mysqli, "INSERT INTO prof_temp (VFECHA,CODIGO,VCANTIDAD,ORDEN,ANEXO) VALUES ('$fecha','$codigo_pro','$cantidad',$id,'$vdocuma')");	
	}
...
<?php
	...
	$vdocuma=$_SESSION['codigo_factura'];
	$sql=mysqli_query($mysqli, "select * from prof_temp where ANEXO='$vdocuma' ");
