...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
	  ...
	  $codigo_usuario    = $_SESSION['codigo_usuario'];
            ...
            $query = mysqli_query($mysqli, "INSERT INTO profor(VDOCUM,VFECHA,VNOMBRE,VRUC,VUSUARIO,AGECODIGO,CLICODIGO,VGLOSA) 
                                            VALUES('$codigo_nota','$fecha_a','$nombre_cliente','$dni','$usuario','$codigo_almacen','$codigo_cliente','$observaciones')")
			...
			$query_detalle = mysqli_query($mysqli, "INSERT INTO profor1(VDOCUM,VFECHA,AGECODIGO,CLICODIGO,CODIGO,VCANTIDAD,ANEXO) 
                                            VALUES('$codigo_nota','$fecha_a','$codigo_almacen','$codigo_cliente','$cod_pro','$cantidad_pro','$nro_factura')")
                                            or die('Error: '.mysqli_error($mysqli));  
